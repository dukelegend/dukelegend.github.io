...
/**
 * Servlet implementation class NCompleteServlet
 */
@WebServlet("/NCompleteServlet")
public class NCompleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NCompleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql2 = "update orders set STATE = '已收货' where BOID ='"+id+"';";
		nOrdersBiz.exceuteUpdate(sql2);
		String sql1 = "update bigorder set STATE = '已收货' where BOID ='"+id+"';";
