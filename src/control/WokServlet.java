...
/**
 * Servlet implementation class WokServlet
 */
@WebServlet("/WokServlet")
...
//		String query=request.getParameter("querys");
		...
		list=ob.getOrder("已完成");//yiwancheng
		
		if(request.getParameter("query")!=null) {
			
			for(WOrder wo: list) {
				if(wo.getBigorder().getBOid().equals(request.getParameter("query"))) {
					list.clear();
					list.add(wo);
					break;
				}
