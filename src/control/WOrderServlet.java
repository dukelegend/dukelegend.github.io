...
/**
 * Servlet implementation class WOrderServlet
 */
@WebServlet("/WOrderServlet")
...
//		String query=request.getParameter("querys");
		...
		list=ob.getOrder("待发货");//待发货daifahuo
...
//		s.setAttribute("rinfo", rlist);
		response.sendRedirect("wOrder.jsp");
	}
